...
try {
  ...
  } = require("next/dist/server/dev/hot-middleware");
  ...
  console.log(
    "   Constructor length (required params):",
    WebpackHotMiddleware.length,
  );
} catch (error) {
...
try {
  ...
  console.log(
    "   - Has publish method:",
    typeof hotMiddleware.publish === "function",
  );
  console.log(
    "   - Has onHMR method:",
    typeof hotMiddleware.onHMR === "function",
  );
  console.log(
    "   - Has close method:",
    typeof hotMiddleware.close === "function",
  );
  ...
  console.log(
    "   - EventStream has publish method:",
    typeof eventStream.publish === "function",
  );
  console.log(
    "   - EventStream has handler method:",
    typeof eventStream.handler === "function",
  );
...
try {
  ...
  const processKeys = Object.keys(process).filter(
    (key) =>
...
try {
  ...
  try {
    ...
    console.log(
      "   Next.js dev server module not directly accessible:",
      err.message,
    );
  }
} catch (error) {
