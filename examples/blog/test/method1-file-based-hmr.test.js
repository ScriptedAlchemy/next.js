...
test('Method 1: File-Based HMR Test', async (t) => {
  ...
  assert.strictEqual(fileHMRResponse.status, 200, 'File-based HMR API should be available');
  ...
  assert.ok(updatedPage.body.includes('Hello world!!'), 'Page should contain Hello world!! after file-based HMR');
