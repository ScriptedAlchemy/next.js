...
console.log(
  "onDemandEntryHandler provides programmatic access to Next.js page",
);
console.log("compilation, but requires substantial Next.js infrastructure.");
console.log(
  "It's best used for extending Next.js dev capabilities rather than",
);
...
console.log(
  "makes it more practical to work within Next.js dev server context.\n",
);
